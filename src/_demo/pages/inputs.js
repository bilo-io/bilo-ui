...
export const InputRanges = (props) => <CodeDocs title={`Ranges`} code={
    <div>
        <Slider
            min={0}
            max={100}
...
export const InputBasic = (props) => <CodeDocs title={`Basic`} code={
    <div>
        <Input
            type='text'
            label='text'
...
export const InputDates = (props) => <CodeDocs title={`Dates`} code={
    <div>
...
export const InputOther = (props) => <CodeDocs title={`Other`} code={
    <div>
...
export const InputSwitch = (props) => <CodeDocs title='Switches' code={
    <div>
        <Switch />
        <Switch
            isRound
...
export const InputRadio = (props) => <CodeDocs title={`Radio`} code={
        <div
            style={{
            display: 'flex',
            flexDirection: 'row',
